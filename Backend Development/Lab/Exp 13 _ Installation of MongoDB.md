...
Before installing, it is helpful to understand the core components you will be interacting with:
...
1. **Download:** Go to the [MongoDB Community Server download page](https://www.mongodb.com/try/download/community) and download the `.msi` installer.
2. **Install:** Run the installer and follow the instructions. It is recommended to install it as a service.
3. **Mongo Shell:** Download the MongoDB Shell (`mongosh`) from [the official website](https://www.mongodb.com/try/download/shell). Unzip it and add the `bin` folder to your Windows System PATH.
4. **Verify:** Open a new Command Prompt or PowerShell and type `mongosh`.

#### **For macOS**

1. **Homebrew Method (Recommended):**
   ```bash
