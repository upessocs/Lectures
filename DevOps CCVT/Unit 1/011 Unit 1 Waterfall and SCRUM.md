The **Waterfall Model** is a traditional software development methodology that follows a linear and sequential approach. It consists of the following **stages**:
