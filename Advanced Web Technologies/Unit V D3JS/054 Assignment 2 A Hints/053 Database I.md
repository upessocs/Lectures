...
1. **Homogeneous DDBMS:** All sites use the same DBMS software.
2. **Heterogeneous DDBMS:** Different sites may run different DBMS software (much more complex, requires gateways).
