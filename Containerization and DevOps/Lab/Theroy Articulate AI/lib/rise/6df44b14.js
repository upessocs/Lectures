"use strict";(self.wpRiseJsonp=self.wpRiseJsonp||[]).push([["defaultVendors-node_modules_pnpm_articulate_design-system_1_13_0__articulate_design-system-to-8c2658"],{57324:(yl,ut,Wa)=>{Wa.r(ut),Wa.d(ut,{Arc:()=>qs,ArcAbstractFlexLayouts:()=>Uo,ArcAbstractGapSizes:()=>ft,ArcAbstractIconSizes:()=>$e,ArcAbstractOrientations:()=>Yo,ArcAbstractPopoverActions:()=>Za,ArcAbstractPopoverModes:()=>xe,ArcAbstractTextLayouts:()=>No,ArcAbstractTextOverflows:()=>gt,ArcAbstractTextSizes:()=>Fo,ArcAvatar:()=>He,ArcAvatarColors:()=>Ft,ArcAvatarColorsReserved:()=>un,ArcAvatarOverflow:()=>Gi,ArcAvatarOverflowSizes:()=>bn,ArcAvatarPile:()=>Hn,ArcAvatarPileSizes:()=>gn,ArcAvatarSizes:()=>hn,ArcAvatarText:()=>Ve,ArcAvatarTextGapSizes:()=>vn,ArcAvatarTextOverflows:()=>mn,ArcAvatarTextSizes:()=>fn,ArcBadge:()=>rc,ArcBadgeContrasts:()=>Ji,ArcBadgeCount:()=>nc,ArcBadgeCountShapes:()=>oc,ArcBadgeCountSizes:()=>ec,ArcBadgeCountVariants:()=>tc,ArcBadgeLayouts:()=>Ki,ArcBadgeSizes:()=>qi,ArcBadgeVariants:()=>Qi,ArcButton:()=>ur,ArcButtonDeprecatedVariants:()=>$o,ArcButtonHierarchies:()=>wi,ArcButtonLayouts:()=>$i,ArcButtonPopoverActions:()=>ki,ArcButtonShapes:()=>bi,ArcButtonSizes:()=>xi,ArcButtonVariants:()=>yi,ArcCheckbox:()=>Ao,ArcCheckboxBar:()=>xc,ArcCheckboxBarLayouts:()=>fc,ArcCheckboxBarOption:()=>bc,ArcCheckboxBarSizes:()=>gc,ArcCheckboxLayouts:()=>uc,ArcCheckboxSizes:()=>hc,ArcCheckboxVariants:()=>vc,ArcDropdownMenu:()=>Ke,ArcIcon:()=>B,ArcIconText:()=>Er,ArcIconTextVariants:()=>ai,ArcInputAction:()=>Tc,ArcLabel:()=>ca,ArcLabelContent:()=>sa,ArcLabelLayouts:()=>cc,ArcLink:()=>Mc,ArcLinkVariants:()=>Lc,ArcModal:()=>rs,ArcModalAlert:()=>es,ArcModalAlertDefaults:()=>Jr,ArcModalAlertVariants:()=>Bc,ArcModalBackdropColors:()=>Oc,ArcModalBodyPaddings:()=>Dc,ArcModalCloseReasons:()=>Vc,ArcModalCommonDefaults:()=>gr,ArcModalCommonVariants:()=>Pc,ArcModalConfirm:()=>Io,ArcModalConfirmDefaults:()=>da,ArcModalConfirmVariants:()=>Rc,ArcModalSizes:()=>Hc,ArcPopover:()=>Ba,ArcPopoverActions:()=>Fn,ArcPopoverAnchors:()=>Qt,ArcPopoverBoundaries:()=>ro,ArcPopoverButton:()=>Pa,ArcPopoverDefaults:()=>wr,ArcPopoverDensities:()=>ao,ArcPopoverModes:()=>Jt,ArcPopoverVariants:()=>Fe,ArcPopoverVariantsWithOutline:()=>Nn,ArcRadio:()=>Lo,ArcRadioBar:()=>ds,ArcRadioBarLayouts:()=>cs,ArcRadioBarOption:()=>ls,ArcRadioBarSizes:()=>ss,ArcRadioLayouts:()=>os,ArcRadioSizes:()=>ns,ArcSelect:()=>Is,ArcSelectLayouts:()=>us,ArcSelectSizes:()=>hs,ArcSelectVariants:()=>vs,ArcSwitch:()=>Rs,ArcSwitchLabelPositions:()=>wa,ArcSwitchSizes:()=>Ls,ArcSwitchStates:()=>ar,ArcSystemAlignments:()=>vt,ArcSystemColors:()=>be,ArcSystemHierarchies:()=>ht,ArcSystemLayouts:()=>Hr,ArcSystemLineHeights:()=>mt,ArcSystemShapes:()=>ge,ArcSystemSizes:()=>yr,ArcSystemVariants:()=>Q,ArcTextAlignments:()=>Us,ArcTextBodyElements:()=>Bo,ArcTextBodySizes:()=>Fs,ArcTextBodyVariants:()=>Ns,ArcTextElements:()=>Oo,ArcTextHeadingElements:()=>Ro,ArcTextHeadingSizes:()=>Ds,ArcTextHeadingVariants:()=>Vs,ArcTextInput:()=>al,ArcTextInputLayouts:()=>Ks,ArcTextInputSizes:()=>Js,ArcTextInputTypes:()=>rl,ArcTextInputVariants:()=>Qs,ArcTextKinds:()=>Bs,ArcTextLineHeights:()=>Ys,ArcTextSubheadingSizes:()=>Hs,ArcTextTitleSizes:()=>Os,ArcToast:()=>Vo,ArcToastPlacements:()=>pl,ArcToastPopoverActions:()=>dl,ArcToastPopoverModes:()=>ll,ArcToastProgressBarVariants:()=>ul,ArcToastSeverities:()=>il,ArcToastSizes:()=>cl,ArcToastVariants:()=>sl,ArcTooltip:()=>xo,ArcTooltipDefaults:()=>Tr,SVGLogoArticulate:()=>Le,SVGLogoProductAI:()=>Me,SVGLogoProductPeek:()=>Pe,SVGLogoProductReach:()=>Re,SVGLogoProductReview:()=>Be,SVGLogoProductRise:()=>Oe,SVGLogoProductStoryline:()=>De,adoptStyles:()=>O,assignRef:()=>bt,bindDelegatedEvents:()=>bo,clamp:()=>xt,createEmptyRect:()=>Ia,css:()=>u,didElementRectChange:()=>$t,extractTextFromReactNode:()=>Ta,getPreferredAnchorForTooltipId:()=>Xe,isDifferent:()=>ea,isFixedDetector:()=>uo,isSame:()=>Ga,joinArray:()=>ho,logError:()=>qn,logMessage:()=>Xn,logWarning:()=>vo,makeHtmlId:()=>Vn,mapDeprecated:()=>Wo,pickFromList:()=>z,shareAdoptedStyles:()=>sn,unbindDelegatedEvents:()=>fi,updatePopoverPosition:()=>Ne,useStableId:()=>Sr});const ge=["circle","square","narrow"],Q=["inherit","common","disabled","neutral","outline","solid","plain","critical","ai","primary","secondary","tertiary","inverse","critical-primary","critical-secondary","ai-primary","ai-secondary","primary-inverse","secondary-inverse","tertiary-inverse","overlay-light","overlay-dark","brand-black","brand-blue","brand","info","success","warning","error","processing"],ht=["primary","secondary","tertiary","plain"],Hr=["hug","fill","icon","gutter","inline"],vt=["inherit","start","left","justify","center","between","around","evenly","stretch","end","right"],mt=["inherit","tight","standard","loose"],yr=["inherit","xxl","xl","lg","md","sm","xs","xxs","custom","fullscreen"],be=["blue","orange","mint","red","yellow","green","maroon","purple","neutral","white","black"],xe=["","auto","manual"],Za=["toggle","show","hide"],$e=["inherit","xl","lg","md","sm","xs"],ft=["inherit","lg","md","sm"],Fo=["inherit","md","sm"],gt=["inherit","wrap","truncate"],No=["gutter","inline"],Uo=["hug","fill"],Yo=["horizontal","vertical"],Wo=(r,a)=>a[r]||r,z=(r,a)=>r.filter(e=>a.includes(e)),bt=(r,a)=>{r&&(typeof r=="function"?r(a):r.current=a)},xt=(r,a=0,e=100)=>Math.min(Math.max(r,a),e),ea=(r,a)=>r!==a,Ga=(r,a)=>r===a,$t=({a:r,b:a})=>ea(r?.top,a?.top)||ea(r?.left,a?.left)||ea(r?.width,a?.width)||ea(r?.height,a?.height);var t=Wa(6534),b=Wa(15648);/**
 * @license
...
`,Sn=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-articulate arc-aw",color:r?.color||"var(--arc-color-logo-articulate, #000000)","aria-label":r?.["aria-label"]||"Articulate Logo"}),jn=r=>{const a={background:["linear-gradient(","to right top, ","var(--arc-color-logo-ai-purple, var(--arc-color-ai-purple-200)), ","var(--arc-color-logo-ai-blue, var(--arc-color-ai-blue-200))",")"].join(""),backgroundClip:"text",color:"transparent",height:"auto",maxHeight:"none"};return(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-ai arc-aw","aria-label":r?.["aria-label"]||"Articulate AI Logo",style:{...r.style,...a}})},En=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-peek arc-aw",color:r?.color||"var(--arc-color-logo-peek, #497add)","aria-label":r?.["aria-label"]||"Articulate Peek Logo"}),_n=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-reach arc-aw",color:r?.color||"var(--arc-color-logo-reach, #0081de)","aria-label":r?.["aria-label"]||"Articulate Reach Logo"}),Tn=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-review arc-aw",color:r?.color||"var(--arc-color-logo-review, #35b062)","aria-label":r?.["aria-label"]||"Articulate Review Logo"}),In=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-rise arc-aw",color:r?.color||"var(--arc-color-logo-rise, var(--arc-color-orange-400))","aria-label":r?.["aria-label"]||"Articulate Rise Logo"}),Ln=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-storyline arc-aw",color:r?.color||"var(--arc-color-logo-storyline, #c560b3)","aria-label":r?.["aria-label"]||"Articulate Storyline Logo"}),Mn=r=>typeof r=="number"?`calc(${r/10}rem * var(--arc-internal-font-size))`:r,B=({children:r,icon:a="fa-regular fa-circle-dashed",color:e,size:n,style:i,...c})=>{const s={...i,"--arc-icon-size":Mn(n),"--arc-icon-color":e},d=!!(c["aria-label"]||c["aria-labelledby"]),l=zn(a),p=typeof l=="string"&&l.length>0?(0,t.jsx)("span",{className:l}):l;return(0,t.jsx)("span",{"aria-hidden":!d||void 0,...c,"arc-icon":"",style:s,children:r||p})};O("ArcIcon",Cn),B.Articulate=Sn,B.AI=jn,B.Peek=En,B.Reach=_n,B.Review=Tn,B.Rise=In,B.Storyline=Ln,B.SVGArticulate=Le,B.SVGAI=Me,B.SVGPeek=Pe,B.SVGReach=Re,B.SVGReview=Be,B.SVGRise=Oe,B.SVGStoryline=De;const Pn=({children:r,icon:a,color:e,...n})=>(0,t.jsx)("span",{...n,"data-element":"anonymous","data-color":"neutral",children:r||(0,t.jsx)(B,{icon:a})}),Xt="blue",qt="neutral",Rn="fa-solid fa-user arc-aw",He=(0,b.forwardRef)(({children:r,size:a,color:e,isActive:n=!0,isAnonymous:i,alt:c,src:s,name:d,email:l,...p},h)=>{const[v,f]=(0,b.useState)(!1),[g,w]=(0,b.useState)(!1),E=H=>{f(!0),w(!1),p.onLoad?.(H)},j=H=>{f(!1),w(!0),p.onError?.(H)},P=ln(d||l),A=!!P,_=i||(!v||g)&&!A,S=!_&&!!s&&!g||void 0,C=(_&&qt||void 0)??(e||void 0)??pn(String(l||d||void 0),Ft,Xt)??Xt,L={src:s,alt:c,isLoaded:v,hasError:g,onLoad:E,onError:j};return(0,b.useEffect)(()=>{_&&f(!1)},[_]),(0,t.jsx)("span",{...p,ref:h,"arc-avatar":"","data-is-inactive":!n||void 0,"data-size":a,"aria-label":(p.title??d??l)||void 0,children:r||(_?(0,t.jsx)(Pn,{icon:Rn,color:qt}):(0,t.jsxs)(t.Fragment,{children:[S&&(0,t.jsx)(yn,{...L}),A&&(0,t.jsx)($n,{initial:P,color:C})]}))})});O("ArcAvatar",xn);const sr=u`${$}•text`,qr=u`${$}•subtext`,va=u`${$}•gap`,Bn=u`
@layer arc-components {
...
`,On="Anonymous",Ve=({children:r,avatar:a={},subtext:e,size:n,gapSize:i,overflow:c,isStrong:s,...d})=>{const l=a.anonymousName||On,p=a.name||a.email||a.src,h=a.name||a.email,v=a.isAnonymous||!p,f=r||v?l:h,g=i!=="inherit"?i:void 0,w=c!=="inherit"?c:void 0;return(0,t.jsxs)("span",{...d,"arc-avatar-text":"","data-gap":g,"data-overflow":w,"is-strong":s?"":void 0,children:[(0,t.jsx)(He,{...a,isAnonymous:v,size:n}),(0,t.jsxs)("span",{"data-element":"text",children:[f,e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("br",{}),(0,t.jsx)("small",{"data-element":"subtext",children:e})]})]})]})};O("ArcAvatarText",Bn);const Dn=u`
@layer arc-components {
...
`,Ue=(0,b.forwardRef)(({progress:r,...a},e)=>(0,t.jsxs)("svg",{...a,ref:e,viewBox:"0 0 100 100","arc-spinner":"",style:{"--arc-spinner-progress":r??""},children:[(0,t.jsx)("circle",{"arc-spinner-circle":"",cx:"50%",cy:"50%",r:"45%",strokeWidth:"12.5%",pathLength:"1"}),(0,t.jsx)("circle",{"arc-spinner-progress":"",cx:"50%",cy:"50%",r:"45%",strokeWidth:"12.5%",pathLength:"1"})]}));Ue.displayName="ArcSpinner",O("ArcSpinner",Gn);const Xn=(...r)=>console.log(...r),vo=(...r)=>console.warn(...r),qn=(...r)=>console.error(...r),Nr=u`arc•icon•text`,G=u`${Nr}•icon`,Y=u`${Nr}•text`,ma=u`${Nr}•subtext`,Ur=u`${Nr}•gap`,Kn=u`
...
`,ai=z(Q,["inherit","primary","secondary","inverse","brand","info","success","warning","critical"]),Er=({children:r,layout:a="gutter",size:e="inherit",variant:n="inherit",tag:i="span",icon:c,text:s,subtext:d,overflow:l,iconSize:p,gapSize:h,isFlipped:v=!1,isStrong:f=!1,...g})=>{const w=r||s,E=!!c,j=!!w,P=a==="gutter",A=a==="inline",_=E&&(!v||P),S=E&&j&&v&&A,C=!!p&&p!=="inherit",L=C&&$e.includes(p)?p:void 0,H=C&&!$e.includes(p)?p:void 0,J=h!=="inherit"?h:void 0,X=l!=="inherit"?l:void 0,V=Gt(c);return(0,t.jsxs)(i,{...g,"arc-icon-text":"","data-variant":n,"data-layout":a,"data-overflow":X,"data-size":e,"data-gap":J,"icon-size":L,"is-flipped":v?"":void 0,"is-strong":f?"":void 0,children:[_&&(0,t.jsx)("span",{"data-element":"icon",children:typeof V=="string"?(0,t.jsx)(B,{icon:V,size:H}):V}),j&&(0,t.jsxs)("span",{"data-element":"text",children:[w,!!d&&(P?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("br",{}),(0,t.jsx)("small",{"data-element":"subtext",children:d})]}):(0,t.jsxs)(t.Fragment,{children:[" ",(0,t.jsx)("span",{"data-element":"subtext",children:d})]}))]}),S&&(0,t.jsx)("span",{"data-element":"icon",children:typeof V=="string"?(0,t.jsx)(B,{icon:V,size:H}):V})]})};O("ArcIconText",ri);const Tr={...wr,popover:"manual",anchorAt:"top-center",boundary:"flip",variant:"common",tailSize:8,offset:4,isInverse:!0,isStrong:!0,hasTail:!0,isEnabled:!0};let re=!1;const ei=100,ti=100;let Ye=!0,We=null;const oi=typeof CSS<"u"&&typeof CSS.supports=="function"&&CSS.supports("selector(:focus-visible)"),ni=r=>r instanceof Element?oi?r.matches(":focus-visible")===!0:Ye:!1,Ze=new WeakMap,Ge=new WeakMap,ae=(r,a)=>{const e=r.get(a);e!=null&&(clearTimeout(e),r.delete(a))},mo=(r,a,e,n)=>{const i=window.setTimeout(()=>{n(),r.delete(a)},e);r.set(a,i)},fo="[aria-describedby]",ii=r=>typeof r=="object"&&r!==null&&r.hasAttribute?.("popover")===!0,go=r=>r instanceof HTMLElement&&r.getAttribute("role")==="tooltip"&&ii(r),ci=r=>!!r&&(r.tagName==="LABEL"||r.hasAttribute("arc-label")),si=r=>r?.match(/\S+/g)??[],Xe=r=>{if(typeof document>"u")return null;const a=document.querySelector(`[aria-describedby~="${r}"]`);return a?a.closest("label,[arc-label]")??a:null},li=r=>{if(!(r instanceof Element))return null;const a=r.closest?.(fo);if(a){const n=a.getAttribute("aria-describedby")??"";if(n)return{anchor:a.closest?.("label,[arc-label]")??a,tooltipId:n}}let e=r;for(;e;){if(ci(e)){const n=e.querySelector?.(fo),i=n?.getAttribute?.("aria-describedby")??"";if(n&&i)return{anchor:e,tooltipId:i}}e=e.parentElement}return null},di=r=>{if(!(r instanceof Element))return null;const a=r.closest?.('[role="tooltip"][popover]')??null;return a instanceof HTMLElement?a:null},pi=r=>r?.id?Xe(r.id):null,ui=r=>{const a=di(r),e=li(r);if(!e&&a){const d=pi(a);return!d||!a.id?null:{anchor:d,tooltip:a}}if(!e)return null;const{anchor:n,tooltipId:i}=e;if(!i)return null;const c=si(i),s=a??c.map(d=>document.getElementById(d)).find(d=>go(d))??null;return go(s)?{anchor:n,tooltip:s}:null},hi=(r,a,e)=>{const n=e instanceof Element?e:null;if(!n)return!1;const i=r===n||r.contains(n),c=a===n||a.contains(n);return i||c},vi=(r,a)=>{if(ae(Ge,r),ae(Ze,r),!a){r.isConnected&&r.showPopover?.();return}mo(Ze,r,ei,()=>{r.isConnected&&r.showPopover?.()})},mi=(r,a)=>{if(ae(Ze,r),ae(Ge,r),!a){r.isConnected&&r.hidePopover?.();return}mo(Ge,r,ti,()=>{r.isConnected&&r.hidePopover?.()})},Ma=(r,a,e,n)=>{const i=ui(a);if(!i)return;const{anchor:c,tooltip:s}=i;if(r){vi(s,n);return}hi(c,s,e)||mi(s,n)};let ee=null,te=null,oe=null,ne=null,ie=null,ce=null,fa=null;const bo=()=>{re||typeof document>"u"||(ce=r=>{Ye=!1,We=r.target},fa=()=>{We=null},ee=r=>Ma(!0,r.target,void 0,!0),te=r=>{ni(r.target)&&Ma(!0,r.target,void 0,!1)},oe=r=>Ma(!1,r.target,r.relatedTarget,!0),ne=r=>{const a=r.relatedTarget??We;Ma(!1,r.target,a,!1)},ie=r=>{r.key==="Tab"&&(Ye=!0),r.key==="Escape"&&Ma(!1,r.target,void 0,!1)},document.addEventListener("pointerdown",ce),document.addEventListener("pointerup",fa),document.addEventListener("pointercancel",fa),document.addEventListener("pointerover",ee),document.addEventListener("focusin",te),document.addEventListener("pointerout",oe),document.addEventListener("focusout",ne),document.addEventListener("keydown",ie),re=!0)},fi=()=>{if(!re||typeof document>"u")return;[["pointerdown",ce],["pointerup",fa],["pointercancel",fa],["pointerover",ee],["focusin",te],["pointerout",oe],["focusout",ne],["keydown",ie]].forEach(([a,e])=>{e&&document.removeEventListener(a,e)}),ee=null,te=null,oe=null,ne=null,ie=null,ce=null,fa=null,re=!1},gi=u`
@layer arc-components {
  [arc-tooltip] {
...
`,xo=(0,b.forwardRef)(({id:r,children:a,slot:e,isEnabled:n=Tr.isEnabled,anchorAt:i=Tr.anchorAt,boundary:c=Tr.boundary,hasTail:s=Tr.hasTail,tailSize:d=Tr.tailSize,offset:l=Tr.offset,isStrong:p=Tr.isStrong,text:h,subtext:v,icon:f,isFlipped:g,...w},E)=>{if(n)try{bo()}catch{}const j=Sr(r,"arc-tooltip"),P=H=>typeof H=="object"&&H!==null&&"tabIndex"in H,A=a,_=!!w.alternateAnchor;let S=null;(0,b.isValidElement)(A)?S=n?(0,b.cloneElement)(A,{"aria-describedby":j,...P(A.props)&&A.props.tabIndex!=null?{}:{tabIndex:0}}):A:!_&&typeof console<"u"&&vo("ArcTooltip expects a single ReactElement child as the trigger.");const C=(0,b.useMemo)(()=>()=>Xe(j),[j]),L=w?.isInverse??Tr.isInverse;return(0,t.jsxs)(t.Fragment,{children:[S,n&&(0,t.jsxs)(Ba,{...w,"arc-tooltip":"",role:"tooltip",id:j,ref:E,popover:Tr.popover,anchorAt:i,boundary:c,variant:Tr.variant,isInverse:L,hasTail:s,tailSize:d,offset:l,hidePopoverButton:!0,alternateAnchor:w.alternateAnchor??C,children:[h&&(0,t.jsx)(Er,{"arc-tooltip-content":"",text:h,subtext:v,icon:f,isFlipped:g,isStrong:p,size:"inherit",variant:"inherit"}),e&&(0,t.jsx)("span",{"arc-tooltip-slot-content":"",children:e})]})]})});O("ArcTooltip",gi);const bi=z(ge,["circle","square","narrow"]),xi=z(yr,["xxl","xl","lg","md","sm"]),$i=z(Hr,["hug","fill","icon"]),yi=z(Q,["common","ai","critical"]),$o=z(Q,["primary","secondary","tertiary","critical-primary","critical-secondary","ai-primary","ai-secondary","primary-inverse","secondary-inverse","tertiary-inverse"]),wi=z(ht,["primary","secondary","tertiary","plain"]),ki=[...Za],F=u`arc•modifier`,o=u`arc•button`,D=u`${o}•spinner`,lr=u`${o}•icon`,M=u`${o}•computed`,Ai=u`
  &[data-size=xxl] {
...
`,yo=(0,t.jsx)(Ue,{}),ur=(0,b.forwardRef)(({children:r,disabled:a,...e},n)=>{const i=(0,b.useRef)(null),{iconEnd:c,iconStart:s,icon:d,text:l,isActive:p,isDisabled:h,isProcessing:v,isProcessingWithText:f,hasLargeIcon:g,tag:w,href:E,type:j,title:P,layout:A,shape:_,size:S="lg",variant:C="common",hierarchy:L="primary",isInverse:H=!1,_isCustom:J,...X}=e,V=w??(E?"a":"button"),br=V==="button"?j||"button":void 0,kr=A==="icon",Ar=f||v||h||a,Ir=X?.["aria-disabled"]||Ar||void 0,q=!kr&&(r||l),xr=f&&yo||s||d,ra=!kr&&(f&&!(s||d)?void 0:c),Lr=(v||f&&kr)&&yo,Zr=C&&$o.includes(C),Gr=(()=>{if(Zr||!["common","critical","ai"].includes(C))return C;const Xr=L||"primary";return C==="common"?H?`${Xr}-inverse`:Xr:`${C}-${Xr}`})(),{tooltip:Mr,...Dr}=X,zr=typeof Mr=="string"?Mr:void 0,R=e.tooltip??zr,cr=!!R,hr=typeof R=="string"?{text:R}:R,er=X["aria-describedby"],W=(0,b.useRef)(void 0),vr=Sr(void 0,"arc-tooltip");cr&&!W.current&&(W.current=e.id?`${e.id}-tooltip`:vr);const Cr=cr?ho([er,W.current]):er,{popoverTarget:$r,popoverTargetAction:aa,...he}=Dr;let ve={popoverTarget:$r||void 0,popoverTargetAction:aa||void 0};return b.version.startsWith("18")&&(ve={popovertarget:$r||void 0,popovertargetaction:aa||void 0}),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(V,{...he,...ve,ref:Xr=>{i.current=Xr,bt(n,Xr)},"arc-button":J?"custom":"",disabled:!E&&Ar||void 0,href:E||void 0,title:cr?void 0:P||void 0,type:br,"data-layout":A,"data-shape":J?void 0:_,"data-size":J?void 0:S,"data-variant":J?void 0:Gr,"has-large-icon":g?"":void 0,"is-active":p?"":void 0,"is-processing":v||f&&kr?"":void 0,"is-processing-with-text":f&&!kr?"":void 0,"is-disabled":Ar||Ir?"":void 0,"aria-disabled":Ir,"aria-describedby":Cr||void 0,children:[(0,t.jsxs)("span",{"arc-button-content":"",children:[!!xr&&(0,t.jsx)(B,{"arc-button-icon":"",icon:xr}),!!q&&(0,t.jsx)("span",{"arc-button-label":"",children:q}),!!ra&&(0,t.jsx)(B,{"arc-button-icon":"",icon:ra})]}),Lr]}),cr&&(0,t.jsx)(xo,{...hr,id:W.current,alternateAnchor:hr?.alternateAnchor??(()=>i.current)})]})});ur.displayName="ArcButton",O("ArcButton",Ii);const Pa=(0,b.forwardRef)((r,a)=>(0,t.jsx)(ur,{...r,ref:a,"arc-popover-button":""})),wo=({isInverse:r=!1,isOpen:a,...e})=>(0,t.jsx)(ur,{...e,icon:"fa-regular fa-xmark",text:"Dismiss",layout:"icon",shape:"square",size:"sm",variant:"common",hierarchy:"tertiary",isInverse:r,"arc-popover-dismiss":""}),Li=({children:r,showDismiss:a,dismissProps:e,tag:n="header",...i})=>(0,t.jsxs)(n,{...i,"arc-popover-header":"",children:[r,a&&(0,t.jsx)(wo,{...e})]}),Mi=({tag:r="article",...a})=>(0,t.jsx)(r,{...a,"arc-popover-body":""}),Pi=({showDivider:r,tag:a="footer",...e})=>(0,t.jsx)(a,{...e,"arc-popover-footer":"","has-divider":r?"":void 0}),Ri=r=>(0,t.jsx)("span",{...r,"arc-popover-tail":""});Pa.displayName="ArcPopoverButton";const m=u`arc•popover`,I=u`${m}•space`,se=u`${m}•font`,mr=u`${m}•shift`,ga=u`${m}•offset`,Yr=u`${m}•outline`,Rr=u`${m}•header`,_r=u`${m}•body`,or=u`${m}•footer`,x=u`${m}•tail`,Bi=u`
  --${m}-position: absolute;
...
`,Ra={SETUP:Bi,POSITION:Oi,VARIANTS:Di,DENSITIES:Hi,ELEMENTS:Vi},Fi=u`
@layer arc-components {
  [arc-popover] {
    ${Ra.SETUP}
    ${Ra.POSITION}
...
`,Ni=(r,a)=>{const e=document.getElementById(r);({toggle:()=>e?.togglePopover(),show:()=>e?.showPopover(),hide:()=>e?.hidePopover()})[a??"toggle"]()},ko=(0,b.forwardRef)(({children:r,popover:a=wr.popover,alternateAnchor:e,alternateAnchorId:n,anchorProps:i,anchorAt:c,boundary:s,density:d=wr.density,variant:l=wr.variant,isInverse:p,hasTail:h,tailSize:v=wr.tailSize,offset:f=wr.offset,hidePopoverButton:g,headerSlot:w,showDismiss:E,dismissProps:j,footerSlot:P,showFooterDivider:A,tag:_="div",contentTag:S="div",onToggle:C,...L},H)=>{const J=(0,b.useRef)(null),X=(0,b.useRef)(null);(0,b.useImperativeHandle)(H,()=>X.current);const[V,br]=(0,b.useState)(!1),[kr,Ar]=(0,b.useState)(c||wr.anchorAt),[Ir,q]=(0,b.useState)({}),[xr,ra]=(0,b.useState)(0),[Lr,Zr]=(0,b.useState)(h?f??0:0),Gr=(0,b.useMemo)(()=>p&&[...Fe].includes(l),[l,p]),Mr=(0,b.useMemo)(()=>({popoverTarget:L.id,"aria-haspopup":!0,"aria-controls":L.id,"aria-expanded":V}),[L.id,V]),Dr=(0,b.useMemo)(()=>({isInverse:Gr,isOpen:V,"aria-label":"Dismiss",...Mr,...j}),[j,Gr,V,Mr]),zr=(0,b.useMemo)(()=>({ref:J,...Mr,...i}),[J,i,Mr]),pr=(0,b.useCallback)(()=>typeof e=="function"?e(zr):n||typeof e=="string"?document.getElementById(n||String(e)):J.current,[n,e,zr]),R=(0,b.useCallback)(({...W})=>{Ar(W.anchorAt),q(W.vars)},[Ar,q]);(0,b.useEffect)(()=>{const W=h?v??0:0,vr=Number(f??0)+W*(Math.sqrt(2)/2);ra(W),Zr(vr)},[h,v,f]);const cr=(0,b.useMemo)(()=>uo(pr()),[pr]),{isFixed:hr,rect:er}=(0,b.useMemo)(()=>cr(),[cr]);return(0,b.useEffect)(()=>{const W=X?.current,vr=pr();if(!vr||!V)return;let Cr=null,$r=null;const aa=()=>{$r&&$t({a:er,b:Cr})?(Cr=er,R(Ne({anchorElement:vr,popoverElement:W,anchorAt:c,boundary:s,offset:Lr,tailSize:xr,isFixed:hr}))):$r=null,$r=requestAnimationFrame(aa)};return $r=requestAnimationFrame(aa),()=>{$r&&cancelAnimationFrame($r)}},[X,pr,hr,er,V,c,s,Lr,xr,R]),(0,b.useEffect)(()=>{const W=X.current;if(!W)return;const vr=Cr=>{const{newState:$r}=Cr;br($r==="open"),R(Ne({anchorElement:pr(),popoverElement:W,anchorAt:c,boundary:s,offset:Lr,tailSize:xr,isFixed:hr})),C?.(Cr)};return W.addEventListener("toggle",vr),()=>W.removeEventListener("toggle",vr)},[X,C,pr,hr,er,c,s,Lr,xr,R]),(0,t.jsxs)(t.Fragment,{children:[!((n||e)&&g)&&(0,t.jsx)(Pa,{...zr}),(0,t.jsxs)(_,{...L,role:L.role??"dialog","arc-popover":kr,ref:X,popover:a,boundary:s,variant:l,density:d,"is-fixed":hr?"":void 0,"is-inverse":Gr?"":void 0,"has-tail":h?"":void 0,style:{...L.style,...Ir},children:[h&&(0,t.jsx)(Ri,{}),(0,t.jsxs)(S,{"arc-popover-content":"",children:[!!w&&(0,t.jsx)(Li,{showDismiss:E,dismissProps:Dr,children:w}),w||P?(0,t.jsx)(Mi,{children:r}):r,!!P&&(0,t.jsx)(Pi,{showDivider:A,children:P})]}),E&&!w&&(0,t.jsx)(wo,{...Dr})]})]})});ko.displayName="ArcPopover";const qe=ko;qe.handlePopover=Ni,qe.Button=Pa;const Ba=qe;O("ArcPopover",Fi);const Ui=u`
@layer arc-components {
...
`,Yi=r=>(0,t.jsx)("ul",{...r,"data-element":"list"}),Wi=r=>(0,t.jsx)("li",{...r,"data-element":"list-item"}),Zi=({count:r,anchorId:a,overflowId:e,shouldShowOverflow:n,...i})=>(0,t.jsx)(He,{title:`+${r}`,children:(0,t.jsx)(Ba.Button,{...i,id:a,popoverTarget:e,text:`+${r}`,variant:"common",hierarchy:"primary",disabled:!n,"data-element":"counter","data-color":"black","data-num-length":r?.toString().length})}),Gi=({children:r,id:a,size:e="sm",overflowCount:n=0,shouldShowOverflow:i=!1,anchorAt:c="bottom-end",boundary:s="flip",...d})=>{const l=Math.min(n,999),p=Sr(a,"arc-avatar-overflow"),h=(0,b.useMemo)(()=>`${p}-anchor`,[p]),v=(0,b.useMemo)(()=>b.Children.toArray(r),[r]);return(0,t.jsxs)(t.Fragment,{children:[l>0&&(0,t.jsx)(Zi,{count:l,anchorId:h,overflowId:p,shouldShowOverflow:i}),i&&l>0&&(0,t.jsx)(Ba,{...d,"arc-avatar-overflow":"",id:p,anchorAt:c,boundary:s,alternateAnchorId:h,hidePopoverButton:!0,variant:"common",isInverse:!0,"data-size":e,children:(0,t.jsx)(Yi,{children:v.map((f,g)=>(0,t.jsx)(Wi,{children:f},g))})})]})};O("ArcAvatarOverflow",Ui);const Xi=u`
@layer arc-components {
...
`,qi=z(yr,["inherit","lg","md","sm"]),Ki=z(Hr,["hug","fill"]),Ji=["high","low"],Qi=z(Q,["brand-black","brand-blue","neutral","info","success","warning","critical","ai","overlay-light","overlay-dark"]),rc=({children:r,icon:a,text:e,isFlipped:n,isFlexible:i,isUppercase:c,variant:s="brand-blue",size:d="inherit",layout:l="hug",contrast:p="high",...h})=>{const v=r||(0,t.jsx)(Er,{icon:a,text:e,isFlipped:n,layout:"gutter"}),f=l==="fill"&&i;return(0,t.jsx)("span",{...h,"arc-badge-wrapper":"",children:(0,t.jsx)("span",{"arc-badge":"","data-contrast":p,"data-variant":s,"data-layout":l,"data-size":d,"data-is-flexible":f?"":void 0,"data-is-uppercase":c?"":void 0,children:v})})};O("ArcBadge",Xi);const ac=u`
@layer arc-components {
...
`,ec=z(yr,["inherit","lg","md","sm"]),tc=z(Q,["neutral","brand","critical","warning","success","inverse"]),oc=z(ge,["square","circle"]),nc=({children:r,text:a,variant:e="neutral",size:n="inherit",shape:i="square",...c})=>{const s=r||a;return(0,t.jsx)("span",{...c,"arc-badge-count-wrapper":"",children:(0,t.jsx)("span",{"arc-badge-count":"","data-variant":e,"data-shape":i,"data-size":n,children:s})})};O("ArcBadgeCount",ac);const ic=u`
@layer arc-components {
...
`,cc=z(Hr,["hug","fill"]),ca=({layout:r,...a})=>(0,t.jsx)("label",{...a,"arc-label":"","data-layout":r});O("ArcLabel",ic);const sc=u`
@layer arc-components {
...
`,sa=r=>(0,t.jsx)("span",{...r,"arc-label-content":""});O("LabelContent",sc);const lc={checkbox:"checkbox",radio:"radio",switch:"radio"},Oa=({id:r,indeterminate:a,type:e,onChange:n,...i})=>{const c=e==="checkbox"&&!!a,s=(0,b.useRef)(null),d=Sr(r,`arc-${e}`),l=p=>h=>{if(!(h?.target instanceof HTMLInputElement))return;const v={checked:h?.target.checked,indeterminate:h?.target?.indeterminate,name:h?.target?.name,value:i?.value};p?.(v,h)};return(0,b.useEffect)(()=>{s.current?.type==="checkbox"&&(s.current.indeterminate=!!a)},[a]),(0,t.jsx)("input",{...i,id:d,ref:s,type:lc[e],"arc-input-type":e,"aria-disabled":i?.disabled||void 0,"data-is-disabled":i?.disabled||void 0,"data-is-checked":i?.checked||void 0,"data-is-indeterminate":c||void 0,onChange:l(n)})},dc=u`
@layer arc-components {
...
`,le=({type:r,...a})=>(0,t.jsx)("span",{"arc-input-mask-wrapper":"",children:(0,t.jsx)("span",{...a,"arc-input-mask":r})});O("ArcBooleanInputMask",dc);const pc=u`
@layer arc-components {
...
`,uc=z(Hr,["hug","fill"]),hc=z(yr,["inherit","md","sm"]),vc=z(Q,["primary","secondary"]),Ao=({children:r,label:a,layout:e,size:n="md",variant:i="primary",useMask:c=!0,...s})=>{const{className:d,title:l,...p}=s,h={className:d,title:l},v=r??a,f=(0,t.jsx)(Oa,{...p,type:"checkbox"}),g=c&&(0,t.jsxs)(le,{type:"checkbox",children:[f,(0,t.jsx)(B,{icon:p?.indeterminate?"fa-solid fa-minus arc-fw":"fa-solid fa-check arc-fw"})]}),w=!!v&&(0,t.jsxs)(ca,{layout:e,children:[g||f,(0,t.jsx)(sa,{children:v})]});return(0,t.jsx)("span",{...h,"arc-checkbox":"","data-size":n,"data-variant":i,children:w||g||f})};O("ArcCheckbox",pc);const mc=u`
@layer arc-components {
...
`,fc=z(Hr,["hug","fill"]),gc=z(yr,["lg","md"]),bc=({children:r,label:a,icon:e,...n})=>{const i=r||(0,t.jsx)(Er,{icon:e,text:a});return(0,t.jsx)("li",{"arc-checkbox-bar-option":"","data-is-checked":n?.checked||void 0,children:(0,t.jsx)(Ao,{...n,label:i,layout:"fill",useMask:!1})})},xc=({children:r,size:a="lg",layout:e="hug",...n})=>(0,t.jsx)("ul",{...n,"arc-checkbox-bar":"","data-size":a,"data-layout":e,role:"group",children:r});O("ArcCheckboxBar",mc);const $c=u`arc•menu`,ba=u`${$c}•item`,yc=u`
@layer arc-components {
...
`,wc=r=>[{test:()=>!!r.variant,value:r.variant},{test:()=>!!r.icon&&typeof r.subtext<"u",value:"icon-text-detail"},{test:()=>!!r.icon,value:"icon-text"},{test:()=>!!r.avatar&&typeof r.subtext<"u",value:"user-detail"},{test:()=>!!r.avatar,value:"user"},{test:()=>typeof r.subtext<"u",value:"text-detail"},{test:()=>!0,value:"text"}],kc={divider:"separator","section-label":"presentation","icon-text-detail":"menuitem","icon-text":"menuitem","user-detail":"menuitem",user:"menuitem","text-detail":"menuitem",text:"menuitem"},la={layout:"gutter",variant:"inherit",overflow:"truncate",gapSize:"md",size:"md"},Ac=({icon:r,...a})=>{const e=r&&typeof r=="string"?`${r.replace(" fa-fw","")} arc-fw`:r;return{divider:(0,t.jsx)("hr",{}),"section-label":(0,t.jsx)(Er,{...a,...la,icon:e,size:"sm",isStrong:!0}),"icon-text":(0,t.jsx)(Er,{...a,...la,icon:e}),"icon-text-detail":(0,t.jsx)(Er,{...a,...la,icon:e,isStrong:!0}),text:(0,t.jsx)(Er,{...a,...la}),"text-detail":(0,t.jsx)(Er,{...a,...la,subtext:a.subtext??"sub",isStrong:!0}),user:(0,t.jsx)(Ve,{...a,...la,size:"sm"}),"user-detail":(0,t.jsx)(Ve,{...a,...la,size:"md",isStrong:!0})}},zc=r=>r?.role??kc[Da(r)]??"menuitem",Da=r=>wc(r)?.find(({test:a})=>a())?.value??"text",zo=r=>a=>Ac(a)[r],Cc=(r,a,e,n)=>{let i=1,c=r;const s=l=>l>=e?0:l+1,d=l=>l<=0?e:l-1;for(;i<=e;){const l=s(c),p=d(c),h={previous:a==="previous"?p:c,actual:c,next:a==="next"?l:c}[a];if(n(h))return h;c=h,i+=1}return-1},Sc=({items:r,filterText:a,renderItem:e,isVisible:n,...i})=>{const c=(0,b.useRef)(null),s=(0,b.useRef)([]),[d,l]=(0,b.useState)(-1),[p,h]=(0,b.useState)(!1),[v,f]=(0,b.useState)(Math.max(r.length-1,0));(0,b.useEffect)(()=>{n&&c.current&&(s.current=Array.from(c.current.querySelectorAll("[arc-button=custom]")))},[n,r]);const g=(0,b.useCallback)(S=>s.current[S]||null,[]),w=(0,b.useCallback)((S,C)=>{const L=Cc(S,C,v,g);l(L),g(L)?.focus()},[v,g]),E=(0,b.useCallback)((S,C)=>()=>{!p&&C&&w(S,"actual")},[p,w]),j={ArrowUp:S=>w(S,"previous"),ArrowDown:S=>w(S,"next"),Home:()=>w(0,"actual"),End:()=>w(v,"actual")},P=S=>C=>{Object.keys(j).includes(C.key)&&(h(!0),C.stopPropagation(),C.preventDefault(),j[C.key](S))},A=(0,b.useMemo)(()=>{const S=a?r.filter(C=>Object.values(C).some(L=>L===a)):r;return f(Math.max(S.length-1,0)),S},[r,a]),_=(0,b.useMemo)(()=>A.map(({itemId:S,role:C,...L},H)=>{const J=Da(L)||"",X=C||zc(L)||"menuitem",V=H===d;return(0,t.jsx)("li",{"arc-menu-item":J,role:X,onMouseEnter:E(H,!!L.onClick),children:e?.(L,H,{filterText:a,isCurrent:V})},S)}),[d,a,A,e,E]);return(0,b.useEffect)(()=>{n&&w(-1,"next")},[n,w]),(0,t.jsx)("ul",{...i,ref:c,"arc-menu":"",role:"menu",onKeyDown:P(d),onMouseLeave:()=>l(-1),onMouseMove:()=>h(!1),tabIndex:n?0:-1,children:_})};O("ArcMenu",yc);const Co=r=>{const{startSlot:a,endSlot:e,onClick:n,href:i,target:c,containerProps:s,isDisabled:d,"aria-disabled":l,tooltip:p,...h}=r,v=Da(h),f=zo(v),g=l??d,w=v==="divider",E=i||n,j=!w,P=j&&a?"":void 0,A=j&&e?"":void 0,_=S=>{g||(S.currentTarget.closest("[arc-popover]")?.hidePopover(),n?.(S.nativeEvent))};return E?(0,t.jsxs)(ur,{...s,tooltip:p,href:i,target:c,"aria-disabled":g?"true":void 0,_isCustom:!0,"arc-dropdown-item":v??"","has-start-slot":P,"has-end-slot":A,onClick:_,children:[j&&a,(0,t.jsx)(f,{...h,"is-item-content":"interactive"}),j&&e]}):(0,t.jsxs)("div",{...s,"arc-dropdown-item":v??"","has-start-slot":P,"has-end-slot":A,children:[j&&a,(0,t.jsx)(f,{...h,"is-item-content":"inert"}),j&&e]})},jc=u`arc•dropdown`,Ec=u`${jc}•menu`,K=u`${Ec}•item`,_c=u`
@layer arc-components {
...
`,So=(0,b.forwardRef)((r,a)=>(0,t.jsx)(Pa,{...r,ref:a,"arc-dropdown-menu-button":""})),Ke=r=>{const{items:a,renderItem:e,...n}=r,[i,c]=(0,b.useState)(!1),s=(0,b.useCallback)((...l)=>e?.(...l)||(0,t.jsx)(Co,{...l[0]}),[e]),d=l=>{c(l.newState==="open"),r?.onToggle?.(l)};return(0,t.jsx)(Ba,{...n,"arc-dropdown":"",variant:"common",onToggle:d,children:(0,t.jsx)(Sc,{"arc-dropdown-menu":"",items:a??[],renderItem:s,isVisible:i})})};So.displayName="ArcDropdownButton",Ke.Button=So,Ke.Item=Co,O("ArcDropdownMenu",_c);const Tc=r=>(0,t.jsx)(ur,{...r,layout:"icon",size:"md",variant:"common",hierarchy:"tertiary"}),fr=u`arc•link`,nr=u`${fr}•icon`,ir=u`${fr}•text`,Ic=u`
@layer arc-components {
...
`,Lc=z(Q,["inherit","primary","secondary","inverse"]),Mc=({children:r,layout:a="gutter",size:e="inherit",variant:n="inherit",tag:i="a",href:c,icon:s,text:d,overflow:l,iconSize:p,gapSize:h,isFlipped:v,isDisabled:f,...g})=>(0,t.jsx)(i,{...g,href:f?void 0:c,"arc-link":"","data-variant":n,"aria-disabled":f,"data-is-disabled":f?"":void 0,children:r||(0,t.jsx)(Er,{icon:s,text:d,overflow:l,iconSize:p,gapSize:h,size:e,layout:a,isFlipped:v})});O("ArcLink",Ic);const Pc=z(Q,["common"]),Rc=z(Q,["common","critical"]),Bc=z(Q,["common","brand","info","success","warning","error","processing"]),Oc=["auto","dark","light","none"],Dc=["auto","all","top-bottom","left-right","left-right-top","left-right-bottom","top-bottom-left","top-bottom-right","none"],Hc=z(yr,["xl","lg","md","sm","custom","fullscreen"]),Vc=["cancel","escape","outside","button:dismiss","button:back","button:primary","button:secondary","button:tertiary","confirm:discard","confirm:cancel"],Ha=u`arc•button•bar`,Fc=u`
@layer arc-components {
...
@layer arc-components {
  ...
  ${Jc}
  ${Qc}
`,da={variant:"common",backdropColor:"auto",message:"You have unsaved changes. Discard them?",onCloseOverride:void 0,isTopLayer:!0,isInverse:!1},Io=({children:r,headerProps:a,bodyProps:e,footerProps:n,...i})=>{const c=(0,b.useRef)(null),{isOpen:s,autoFocusId:d,isTopLayer:l=da.isTopLayer,isInverse:p=da.isInverse,backdropColor:h=da.backdropColor,variant:v=da.variant,message:f=da.message,onCloseOverride:g=da.onCloseOverride,onConfirmDiscard:w,onConfirmCancel:E,...j}=i,{slotStart:P,TitleElement:A,titleContent:_,slotEnd:S,...C}=a||{},{primaryButton:L,secondaryButton:H,...J}=n||{},X=!!(_||P||S),V=!!g,br=q=>V?g?.("confirm:discard",q,c.current??void 0):w?.("confirm:discard",q),kr=q=>V?g?.("confirm:cancel",q,c.current??void 0):E?.("confirm:cancel",q);at({modalRef:c,onClose:g}),et({modalRef:c,isOpen:s,isTopLayer:l}),tt({modalRef:c,isOpen:s,autoFocusId:d});const Ar=q=>{kr(q),H?.onClick?.(q)},Ir=q=>{br(q),L?.onClick?.(q)};return(0,t.jsx)("dialog",{...j,ref:c,"arc-modal":"","is-confirm":v||"","is-inverse":p?"":void 0,"is-top-layer":l?"":void 0,"is-backdrop":h==="auto"?void 0:h,"data-size":"sm",closedby:"none",onKeyDown:Wc("none"),children:(0,t.jsxs)(nt,{children:[X&&(0,t.jsxs)(To,{...C,children:[P&&(0,t.jsx)("div",{"header-slot":"start",children:P}),(0,t.jsx)("div",{"header-slot":"content",children:(0,t.jsx)(it,{TitleElement:A,titleContent:_})}),S&&(0,t.jsx)("div",{"header-slot":"end",children:S})]}),(0,t.jsx)(ct,{...e,children:r||f&&(0,t.jsx)("p",{style:{margin:0},children:f})}),(0,t.jsx)(st,{...J,children:(0,t.jsxs)(Je,{children:[(0,t.jsx)(ur,{...H,text:H?.text||"Cancel",variant:"common",hierarchy:"secondary",isInverse:p,onClick:Ar}),(0,t.jsx)(ur,{...L,text:L?.text||"Discard",variant:v??"common",hierarchy:"primary",isInverse:p,onClick:Ir})]})})]})})};O("ArcModalConfirm",lt);const gr={size:"md",variant:"common",backdropColor:"auto",isTopLayer:!0,isInverse:!1,showDismiss:!0,closeOnEsc:!0,closeOnBackdrop:!1,hasConfirmFlow:!1,hasUnsavedChanges:!1,onCloseOverride:void 0,bypassConfirmWhen:{didPressEscapeKey:!1,didClickBackdrop:!1,didClickGoBackButton:!1,didClickDismissButton:!1,didClickPrimaryButton:!1,didClickSecondaryButton:!1,didClickTertiaryButton:!1},headerProps:{showDivider:!1},bodyProps:{padding:"auto"},footerProps:{showDivider:!1}},rs=({children:r,confirmProps:a,headerProps:e,bodyProps:n,dismissProps:i,footerProps:c,...s})=>{const d=(0,b.useRef)(null),[l,p]=(0,b.useState)(!1),{isOpen:h,autoFocusId:v,isTopLayer:f=gr.isTopLayer,isInverse:g=gr.isInverse,backdropColor:w=gr.backdropColor,hasConfirmFlow:E=gr.hasConfirmFlow,hasUnsavedChanges:j=gr.hasUnsavedChanges,onCloseOverride:P=gr.onCloseOverride,bypassConfirmWhen:A=gr.bypassConfirmWhen??{},size:_=gr.size,closeOnBackdrop:S=gr.closeOnBackdrop,closeOnEsc:C=gr.closeOnEsc,showDismiss:L=gr.showDismiss,onActionError:H,onClose:J,onToggle:X,width:V,height:br,style:kr,...Ar}=s,{showGoBack:Ir,goBackProps:q,slotStart:xr,TitleElement:ra,titleContent:Lr,slotEnd:Zr,showDivider:Gr=gr.headerProps?.showDivider,...Mr}=e??{},{slotStart:Dr,primaryButton:zr,secondaryButton:pr,tertiaryButton:R,showDivider:cr=gr.footerProps?.showDivider,...hr}=c??{},er=!!(Ir||Lr||xr||Zr),W=!!(zr||pr||R),vr=!!(W||Dr),Cr=!!(E&&j),$r=C?"closerequest":"none",{didPressEscapeKey:aa,didClickBackdrop:he,didClickGoBackButton:ve,didClickDismissButton:Xr,didClickPrimaryButton:vl,didClickSecondaryButton:ml,didClickTertiaryButton:fl}=A,me=Va({modalRef:d,shouldConfirm:Cr,setIsConfirming:p,onCloseOverride:P});at({modalRef:d,shouldConfirm:Cr,setIsConfirming:p,onClose:J,onToggle:X}),et({modalRef:d,isOpen:h,isTopLayer:f}),tt({modalRef:d,isOpen:h,autoFocusId:v}),Eo({modalRef:d,isOpen:h,closeOnBackdrop:S,attemptCloseModal:he?Va({modalRef:d,shouldConfirm:Cr&&!he,setIsConfirming:p}):me}),_o({modalRef:d,isOpen:h,closeOnEsc:C,closedBy:$r,attemptCloseModal:aa?Va({modalRef:d,shouldConfirm:Cr&&!aa,setIsConfirming:p}):me});const gl=()=>p(!1),bl=(Ya,fe)=>me(Ya)(fe),ka=(Ya,fe,pt)=>async Aa=>{Aa?.preventDefault?.(),Aa?.stopPropagation?.();const xl=()=>fe?Va({modalRef:d,shouldConfirm:Cr&&!fe,setIsConfirming:p})(Ya,pt?.onCloseCallback)(Aa):me(Ya,pt?.onCloseCallback)(Aa);try{await pt?.onClick?.(Aa),xl()}catch($l){H?.($l,{reason:Ya,event:Aa})}};return(0,t.jsxs)("dialog",{...Ar,ref:d,"arc-modal":"","is-inverse":g?"":void 0,"is-top-layer":f?"":void 0,"is-backdrop":w==="auto"?void 0:w,"data-size":_,closedby:$r,style:{"--arc-modal-width":V??"","--arc-modal-height":br??"",...kr},children:[!er&&L&&(0,t.jsx)("div",{"arc-modal-dismiss":"",children:(0,t.jsx)(ot,{...i,isInverse:g,onClick:ka("button:dismiss",Xr,i)})}),(0,t.jsxs)(nt,{inert:l?"":void 0,children:[er&&(0,t.jsxs)(To,{...Mr,showDivider:Gr,children:[Ir&&(0,t.jsx)("div",{"header-slot":"go-back",children:(0,t.jsx)(ur,{"arc-modal-go-back":"",icon:"fa-regular fa-arrow-left fa-fw",text:"Go Back","aria-label":"Go Back",...q,layout:"icon",size:"md",variant:"common",hierarchy:"secondary",isInverse:g,onClick:ka("button:back",ve,q)})}),xr&&(0,t.jsx)("div",{"header-slot":"start",children:xr}),(0,t.jsx)("div",{"header-slot":"content",children:(0,t.jsx)(it,{TitleElement:ra,titleContent:Lr})}),Zr&&(0,t.jsx)("div",{"header-slot":"end",children:Zr}),L&&(0,t.jsx)("div",{"header-slot":"dismiss",children:(0,t.jsx)(ot,{...i,isInverse:g,onClick:ka("button:dismiss",Xr,i)})})]}),(0,t.jsx)(ct,{...n,children:r}),vr&&(0,t.jsxs)(st,{...hr,showDivider:cr,children:[Dr&&(0,t.jsx)("div",{"footer-slot":"content",children:Dr}),W&&(0,t.jsxs)(Je,{children:[R&&(0,t.jsx)(ur,{...R,text:R?.text||"Button",isInverse:g,variant:"common",hierarchy:"tertiary",onClick:ka("button:tertiary",fl,R)}),pr&&(0,t.jsx)(ur,{...pr,text:pr?.text||"Cancel",isInverse:g,variant:"common",hierarchy:"secondary",onClick:ka("button:secondary",ml,pr)}),zr&&(0,t.jsx)(ur,{...zr,text:zr?.text||"Action",isInverse:g,variant:"common",hierarchy:"primary",onClick:ka("button:primary",vl,zr)})]})]})]}),E&&(0,t.jsx)(Io,{isOpen:l,isInverse:g,isTopLayer:f,backdropColor:w,...a,onConfirmDiscard:bl,onConfirmCancel:gl})]})};O("ArcModal",lt);const Jr={variant:"common",backdropColor:"auto",showDismiss:!0,closeOnBackdrop:!1,closeOnEsc:!0,onCloseOverride:void 0,isTopLayer:!0,isInverse:!1},as={common:"fa-solid fa-cat-space",brand:"fa-kit fa-articulate",success:"fa-solid fa-badge-check",warning:"fa-solid fa-triangle-exclamation",error:"fa-duotone fa-light-emergency-on",info:"fa-solid fa-circle-info",processing:(0,t.jsx)(Ue,{"arc-modal-spinner":""})},es=({children:r,dismissProps:a,bodyProps:e,footerProps:n,...i})=>{const c=(0,b.useRef)(null),{isOpen:s,autoFocusId:d,isTopLayer:l=Jr.isTopLayer,isInverse:p=Jr.isInverse,backdropColor:h=Jr.backdropColor,closeOnBackdrop:v=Jr.closeOnBackdrop,closeOnEsc:f=Jr.closeOnEsc,variant:g=Jr.variant,icon:w,TitleElement:E,titleContent:j,message:P,showDismiss:A,onCloseOverride:_=Jr.onCloseOverride,onClose:S,onToggle:C,...L}=i,{primaryButton:H,...J}=n??{},X=w||as[g],V=f?"closerequest":"none",br=Va({modalRef:c,onCloseOverride:_});return at({modalRef:c,onClose:S,onToggle:C}),et({modalRef:c,isOpen:s,isTopLayer:l}),tt({modalRef:c,isOpen:s,autoFocusId:d}),Eo({modalRef:c,isOpen:s,closeOnBackdrop:v,attemptCloseModal:br}),_o({modalRef:c,isOpen:s,closeOnEsc:f,closedBy:V,attemptCloseModal:br}),(0,t.jsxs)("dialog",{...L,ref:c,"arc-modal":"","is-alert":g||"","is-inverse":p?"":void 0,"is-top-layer":l?"":void 0,"is-backdrop":h==="auto"?void 0:h,"data-size":"sm",closedby:V,children:[A&&(0,t.jsx)("div",{"arc-modal-dismiss":"",children:(0,t.jsx)(ot,{...a,isInverse:p,onClick:br("button:dismiss",a?.onClick)})}),(0,t.jsxs)(nt,{children:[(0,t.jsx)(ct,{...e,children:r||(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(Uc,{glyph:X,variant:g}),(0,t.jsx)(it,{TitleElement:E,titleContent:j}),(0,t.jsx)(Yc,{message:P})]})}),(0,t.jsx)(st,{...J,children:(0,t.jsx)(Je,{orientation:"vertical",children:(0,t.jsx)(ur,{...H,text:H?.text||"Close",variant:"common",hierarchy:"primary",isInverse:p,onClick:br("button:primary",H?.onClick)})})})]})]})};O("ArcModalAlert",lt);const ts=u`
@layer arc-components {
...
`,os=z(Hr,["hug","fill"]),ns=z(yr,["inherit","md","sm"]),Lo=({children:r,label:a,layout:e,size:n="md",useMask:i=!0,...c})=>{const{className:s,title:d,...l}=c,p={className:s,title:d},h=r??a,v=(0,t.jsx)(Oa,{...l,type:"radio"}),f=i&&(0,t.jsxs)(le,{type:"radio",children:[v,(0,t.jsx)(B,{icon:"fa-solid fa-circle-small arc-fw"})]}),g=!!h&&(0,t.jsxs)(ca,{layout:e,children:[f||v,(0,t.jsx)(sa,{children:h})]});return(0,t.jsx)("span",{...p,"arc-radio":"","data-size":n,children:g||f||v})};O("ArcRadio",ts);const is=u`
@layer arc-components {
...
`,cs=z(Hr,["hug","fill"]),ss=z(yr,["lg","md"]),ls=({children:r,label:a,icon:e,...n})=>{const i=r||(0,t.jsx)(Er,{icon:e,text:a});return(0,t.jsx)("li",{"arc-radio-bar-option":"","data-is-checked":n?.checked||void 0,children:(0,t.jsx)(Lo,{...n,label:i,layout:"fill",useMask:!1})})},ds=({children:r,size:a="lg",layout:e="hug",...n})=>(0,t.jsx)("ul",{...n,"arc-radio-bar":"","data-size":a,"data-layout":e,role:"radiogroup",children:r});O("ArcRadioBar",is);const Mo=z(Hr,["fill","hug"]),Po=z(yr,["inherit","xl","lg","md"]),ps=z(Q,["outline","solid","plain"]),us=Mo,hs=Po,vs=z(Q,["outline","solid","plain"]),ya=r=>(0,t.jsx)(t.Fragment,{children:!!r.children&&(0,t.jsx)("span",{...r})}),ms=r=>(0,t.jsx)(t.Fragment,{children:!!r.children&&(0,t.jsx)("span",{...r})}),dt=({children:r,...a})=>(0,t.jsx)(t.Fragment,{children:!!r&&(0,t.jsx)(ca,{...a,children:(0,t.jsx)(sa,{children:r})})}),fs=({children:r,layout:a,size:e,variant:n,tag:i="span",...c})=>(0,t.jsx)(i,{...c,"data-layout":a,"data-size":e,"data-variant":n,children:r}),gs=()=>(0,t.jsx)("span",{"input-element":"spacer"}),bs=r=>(0,t.jsx)(ya,{...r,"input-element":"header"}),xs=r=>(0,t.jsx)(dt,{...r,"input-element":"header-label"}),$s=r=>(0,t.jsx)(ya,{...r,"input-element":"header-slot"}),ys=r=>(0,t.jsx)(ya,{...r,"input-element":"body"}),ws=r=>(0,t.jsx)(dt,{...r,"input-element":"input-prefix"}),ks=r=>(0,t.jsx)(dt,{...r,"input-element":"input-suffix"}),As=r=>(0,t.jsx)(ms,{...r,"input-element":"input-action"}),zs=r=>(0,t.jsx)(ya,{...r,"input-element":"footer"}),Cs=r=>(0,t.jsx)(ya,{...r,"input-element":"footer-caption"}),Ss=r=>(0,t.jsx)(ya,{...r,"input-element":"footer-slot"}),js=r=>a=>{if(!(a?.target instanceof HTMLInputElement))return;const e={name:a?.target?.name,value:a?.target?.value};r?.(e,a)},Es=u`
@layer arc-components {
...
`,_s={onChangeHandler:js,Wrapper:fs,Spacer:gs,Header:bs,HeaderLabel:xs,HeaderSlot:$s,InputBody:ys,InputPrefix:ws,InputSuffix:ks,InputAction:As,Footer:zs,FooterCaption:Cs,FooterSlot:Ss};O("ArcInput",Es);const U=_s,ue=u`arc•select`,Qr=u`${ue}•picker`,Or=u`${ue}•option`,Na=u`${ue}size`,Wr=u`${ue}•space`,Ts=u`
@layer arc-components {
...
`,Rs=({disabled:r,id:a,name:e,size:n="md",value:i,label:c,labelPosition:s=wa.After,onChange:d,labelOff:l,labelOn:p,...h})=>{const v=Sr(e,"arc-switch-name"),f=Sr(a,"arc-switch"),g=(j,P)=>{const A=j.checked?ar.On:ar.Off;d?.({...j,value:A},P)};!c&&(p||l)&&(c=p||l,s=p?wa.After:wa.Before);const w=(0,t.jsxs)(le,{type:"checkbox",children:[(0,t.jsx)(Oa,{type:"checkbox",name:v,id:f,checked:i===ar.On,disabled:r,role:"switch","aria-checked":i===ar.On,"aria-label":c?void 0:"Toggle switch",tabIndex:0,onChange:g}),(0,t.jsx)("span",{"data-element":"mask","aria-hidden":"true",tabIndex:-1})]}),E=(0,t.jsx)(ca,{htmlFor:f,"arc-switch-label":s,children:(0,t.jsx)(sa,{children:c})});return l&&p?(0,t.jsx)(Ms,{...h,disabled:r,id:a,name:e,labelOff:l,labelOn:p,size:n,value:i,onChange:d}):(0,t.jsxs)("span",{...h,"arc-switch":"","data-state":i,"data-size":n,"data-label-position":s,role:"presentation","aria-live":"off",children:[c&&s===wa.Before&&E,w,c&&s===wa.After&&E]})};O("ArcSwitch",Ps);const Bs=["title","heading","subheading","body"],Ro=["h1","h2","h3","h4","h5","h6"],Bo=["code","div","li","p","pre","span"],Oo=[...Ro,...Bo],Os=["title-inherit","title-lg","title-md","title-sm"],Ds=["heading-inherit","heading-lg","heading-md","heading-sm"],Hs=["subheading-inherit","subheading-lg","subheading-md","subheading-sm"],Vs=z(Q,["inherit","primary","primary-inverse"]),Fs=["body-inherit","body-lg","body-md","body-sm","body-xs"],Ns=z(Q,["inherit","primary","secondary","primary-inverse","secondary-inverse","critical","warning","success","info"]),Us=z(vt,["inherit","start","center","justify","end"]),Ys=z(mt,["inherit","loose","standard","tight"]),Ws={h1:"title",h2:"heading",h3:"heading",h4:"subheading",h5:"subheading",h6:"subheading",p:"body",span:"body",div:"body",code:"body",pre:"body",li:"body"},Zs=r=>{const{align:a,lineHeight:e,size:n,variant:i,isMonospace:c,tag:s,...d}=r,l=Ws?.[s]??"body",p=n?.includes("inherit")?n?.split("-")?.[0]:n;return{...d,"arc-text":p||l,"data-is-monospace":c?"":void 0,"data-align":a?.includes("inherit")?void 0:a,"data-variant":i?.includes("inherit")?void 0:i,"data-line-height":e?.includes("inherit")?void 0:e}},Gs=u`
@layer arc-components {
...
`,Xs=r=>(0,b.forwardRef)((a,e)=>(0,b.createElement)(r,{...Zs({...a,tag:r}),ref:e})),qs=[...Oo].reduce((r,a)=>({...r,[a]:Xs(a)}),{});O("Arc",Gs);const Ks=Mo,Js=Po,Qs=z(ps,["outline","solid"]),rl=["text","number","password","email","url"],al=(0,b.forwardRef)(({layout:r="hug",size:a="inherit",variant:e="outline",inputProps:n,headerLabel:i,headerSlot:c,inputPrefix:s,inputAction:d,inputSuffix:l,footerCaption:p,footerSlot:h,...v},f)=>{const{id:g,onChange:w,...E}=n,j=E?.type||"text",P=E?.disabled||void 0,A=E?.readOnly||void 0,_=E?.required||void 0,S=!!(i||c),C=!!(p||h);return(0,t.jsxs)(U.Wrapper,{...v,"arc-text-input":"","arc-input":j,layout:r,size:a,variant:e,children:[S&&(0,t.jsxs)(U.Header,{children:[(0,t.jsx)(U.HeaderLabel,{htmlFor:g,children:i}),!!c&&(0,t.jsx)(U.Spacer,{}),(0,t.jsx)(U.HeaderSlot,{children:c})]}),(0,t.jsxs)(U.InputBody,{children:[(0,t.jsx)(U.InputPrefix,{htmlFor:g,children:s}),(0,t.jsx)("input",{...E,ref:f,id:g,"arc-input-type":j,onChange:U.onChangeHandler(w),"aria-disabled":P,"aria-readonly":A,"aria-required":_}),(0,t.jsx)(U.InputSuffix,{htmlFor:g,children:l}),(0,t.jsx)(U.InputAction,{children:d})]}),C&&(0,t.jsxs)(U.Footer,{children:[(0,t.jsx)(U.FooterCaption,{children:p}),!!h&&(0,t.jsx)(U.Spacer,{}),(0,t.jsx)(U.FooterSlot,{children:h})]})]})}),Do=u`arc•progress`,Ho=u`${Do}•bar`,Ua=u`${Do}•value`,el=u`
@layer arc-components {
[arc-progress-bar] {
...
`,tl=({progress:r=0,variant:a="common",...e})=>(0,t.jsxs)("progress",{...e,"arc-progress-bar":"","data-variant":a,value:r,max:e.max||100,"aria-valuenow":r,"aria-valuemax":e.max||100,children:[r,"% "]});O("ArcProgressBar",el);const ol=u`
@layer arc-components {
...
`,nl=z(Q,["common","ai","critical"]),il=["default","success","warning","error"],cl=z(yr,["inherit","md"]),sl=z(Q,["common"]),ll=[...xe],dl=[...Za],pl=["top-left","top-center","top-right","center","bottom-left","bottom-center","bottom-right"],ul=nl.filter(r=>r!=="critical"),hl=(r,a="toggle")=>{const e=document.getElementById(r);({toggle:()=>e?.togglePopover(),show:()=>e?.showPopover(),hide:()=>e?.hidePopover()})[a]()},Vo=({id:r,children:a,icon:e,heading:n,subtext:i,dismissProps:c,showDismiss:s=!0,onClose:d,actionSlot:l,size:p="md",variant:h="common",placement:v="bottom-left",getToastId:f,progressBarProps:g,severity:w,...E})=>{const j=()=>{d?.()},P=!!l||s,A=Sr(r,"arc-toast"),{variant:_,hierarchy:S,...C}=c||{};(0,b.useEffect)(()=>{f?.(A)},[f,A]);const L=Gt(e);return(0,t.jsx)("div",{...E,"arc-toast":"","data-size":p,"data-variant":h,"data-placement":v,"data-severity":w||void 0,id:A,children:(0,t.jsxs)("div",{"arc-toast-content-grid":"",children:[(0,t.jsxs)("div",{"arc-toast-body":"",children:[e&&(0,t.jsx)(B,{icon:L,"arc-toast-icon":""}),(0,t.jsx)("div",{"arc-toast-content":"",children:a||(0,t.jsxs)(t.Fragment,{children:[n&&(0,t.jsx)("header",{"arc-toast-heading":"",children:(0,t.jsx)("strong",{children:n})}),i&&(0,t.jsx)("p",{"arc-toast-subtext":"",children:i})]})})]}),P&&(0,t.jsxs)("div",{"arc-toast-actions":"",children:[l,s&&(0,t.jsx)(ur,{icon:"fa-regular fa-xmark-large",layout:"icon",variant:"common",hierarchy:"tertiary",isInverse:!0,size:"md",shape:"square","aria-label":"Dismiss",...C,popoverTarget:A,onClick:j})]}),g&&(0,t.jsx)(tl,{...g,variant:w==="error"?"critical":g.variant,"arc-toast-progress-bar":""})]})})};Vo.handleToast=hl,O("ArcToast",ol)}}]);
